...
dataloader = DataLoader(
    dataset=ImageDataset(r"C:\Users\XXX\PycharmProjects\secStudent\images\dataset", transforms_=transforms_, unaligned=False),
...
val_dataloader = DataLoader(
    dataset=ImageDataset(r"C:\Users\XXX\PycharmProjects\secStudent\images\dataset", transforms_=transforms_, unaligned=False, mode="test"),
    batch_size=5,
    shuffle=True,
    num_workers=0,
    drop_last=True,
...
for epoch in range(opt.epoch, opt.n_epochs):
    for i, batch in enumerate(dataloader):
        ...
        fake_B = G_AB(real_A)
        loss_GAN_AB = criterion_GAN(D_B(fake_B[1]), valid) + 0.1 * criterion_cycle(fake_B[1], real_B) + 0.1 * criterion_cycle2(fake_B[0], real_B)
        # fake_A = G_BA(real_B)
